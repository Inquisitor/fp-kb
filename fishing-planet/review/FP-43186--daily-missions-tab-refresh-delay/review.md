...
- Connected jitter design (`GenerationRefreshJitterSeconds`) to save-removal after user surfaced the link from prior off-channel context: per-node jitter does not solve aggregate central-DB load; suppressing forced save is the actual mitigation.
