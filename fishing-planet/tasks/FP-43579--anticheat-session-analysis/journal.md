...
## Status
Phase 3 (subtask decomposition) done. Plan at [artifacts/plan.md](artifacts/plan.md), per-subtask files in [artifacts/subtasks/](artifacts/subtasks/). Vertical-slice ordering (VS0..VS5), 14 subtasks total. Architecture corrections (retention) applied as VS0 (DOC-000, done 2026-05-03) — Mongo retention manifest deferred to KB module promotion (DOC-003 in backlog, out of scope).
Next: Phase 4 — implementation, starting from VS1 (BCK-001 / FRT-001 / FRT-002).
