...
BEGIN
    ...
    DECLARE @Note            nvarchar(300) = N'Auto-ban by Stan via FP-43631 follow-up 2026-07-13 - rating-drop abuse (week-10, adversarial-reviewed: prosecutor/defense/judge per case)';
